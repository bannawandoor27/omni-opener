        ...
        },
        {
          ...
          onClick: function (h) {
            ...
            renderer.domElement.toBlob(function (blob) {
              h.download(h.getFile().name.replace(/\.(glb|gltf)$/, '') + '-screenshot.png', blob, 'image/png');
            }, 'image/png');
          }
        }
      ],
      ...
      onFile: function (file, content, h) {
        ...
        h.loadScripts([
          ...
          loader.parse(content, '', function (gltf) {
            ...
            lightSlider.oninput = function (e) {
            ...
            h.showError('Rendering Failed', 'Could not parse the 3D model. Error: ' + err.message);
          });
        });
      },
