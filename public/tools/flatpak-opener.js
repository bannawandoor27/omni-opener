  ...
  window.initTool = function (toolConfig, mountEl) {
    OmniTool.create(mountEl, toolConfig, {
      ...
      onFile: async function (file, content, h) {
        ...
        // 3. Flatpak Analysis
        // OSTree repos / Flatpak bundles don't have a single simple magic byte at the start usually,
        // but we can at least show the analysis.
          ...
          <div class="p-6 space-y-6 font-sans">
            <div class="flex items-center justify-between border-b border-surface-200 pb-4">
              <div>
                ...
                <p class="text-sm text-surface-500">${(file.size / 1024).toFixed(2)} KB • Flatpak Bundle</p>
              </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div class="bg-surface-50 rounded-xl p-4 border border-surface-200">
                ...
                <div class="text-sm text-surface-600">
                  <p>Flatpak application bundle or repository.</p>
                  <p class="mt-2 text-xs">Flatpak uses OSTree for version control and distribution of Linux applications.</p>
                </div>
              </div>
            </div>
