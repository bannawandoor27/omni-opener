(function () {
  ...
  window.initTool = function (toolConfig, mountEl) {
          ...
          <div class="p-6 space-y-6 font-sans">
            <div class="flex items-center justify-between border-b border-surface-200 pb-4">
              <div>
                ...
                <p class="text-sm text-surface-500">${(file.size / 1024).toFixed(2)} KB • RPM Package</p>
              </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <!-- RPM Info Card -->
              <div class="bg-surface-50 rounded-xl p-4 border border-surface-200">
                <h4 class="text-sm font-bold text-surface-700 mb-3 uppercase tracking-wider">RPM Lead Info</h4>
                ${rpmInfo.isValid ? `
                  <div class="space-y-2 text-sm">
                    <div class="flex justify-between"><span class="text-surface-500">Version:</span> <span>${rpmInfo.version}</span></div>
                ...
                ` : `
                  <div class="flex items-center justify-center h-24 text-surface-400 italic">No valid RPM lead found</div>
                `}
              </div>
            </div>
    ...
    function getRpmArch(arch) {
      const arches = { 1: 'i386', 2: 'Alpha', 3: 'SPARC', 4: 'MIPS', 5: 'PowerPC', 6: '68000', 7: 'SGI', 8: 'RS6000', 9: 'IA64', 10: 'SPARC64', 11: 'x86_64', 12: 'ARM' };
