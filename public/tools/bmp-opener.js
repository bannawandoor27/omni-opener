 ...
 * Uses OmniTool SDK. Displays BMP images with zoom, rotate, and metadata.
 */
(function () {
  'use strict';
  ...
  window.initTool = function (toolConfig, mountEl) {
    ...
    OmniTool.create(mountEl, toolConfig, {
      accept: '.bmp',
      binary: true,
      infoHtml: '<strong>BMP Opener:</strong> View BMP images with zoom and rotation controls. All processing is 100% local.',
      ...
      onFile: function (file, content, h) {
        ...
        img.onerror = function() {
          h.showError('Failed to load image', 'The file may be corrupted or not a valid BMP image.');
        };
        img.src = previewUrl;
      },
